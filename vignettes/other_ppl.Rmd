...
- Observation model: $y_j \sim \mbox{Normal}(\theta_j, \sigma_j^2)$  
- Non-centered prior: $\theta_j = \mu + \tau \cdot \eta_j, \eta_j \sim \mbox{Normal}(0,1)$  
- Weakly informative priors: $\mu \sim \mbox{Normal}(0, 10)$, $\tau \sim \mbox{Uniform}(0, 25)$  

...
$$
\begin{aligned}
y_j \mid \theta_j &\sim \mathcal{N}(\theta_j, \sigma_j^2), \quad j = 1, \dots, 8 \\
\theta_j &= \mu + \tau \eta_j, \quad \eta_j \sim \mathcal{N}(0,1) \\
...
# Build the model
model_nimble <- nimbleModel(code = eight_schools_code, data = data_list, constants = constants)

...
For further guidance, the rest of this README summarises most of the FAQ and additional instructions for installing Julia, troubleshooting, and running `rjuliabugs` in parallel. We recommend reading the following sections:
...
Last, for complete documentation with working examples and more details on `rjuliabugs` functionalities, see the [rjuliabugs vignette](https://turinglang.org/JuliaBUGS.jl/stable/example/).

See also:  
- [JuliaBUGS Documentation](https://turinglang.org/JuliaBUGS.jl/stable/)  
- [JAGS Source Code](https://sourceforge.net/p/mcmc-jags/code-0/ci/default/tree/)
